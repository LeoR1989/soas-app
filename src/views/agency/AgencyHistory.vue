            ...
            <div class="flex justify-between items-start">
              <div class="flex-1">
                ...
                <div class="text-caption text-muted">
                  💎 {{ $t('agencyBills.diamondsDeducted') || 'Diamonds Deducted' }}: {{ record.diamondsDeducted.toLocaleString() }} | {{ $t('agencyBills.fee') || 'Fee' }}: {{ record.fee.toFixed(2) }} USD | {{ record.createdAt }}
                </div>
                <!-- 子状态显示 -->
