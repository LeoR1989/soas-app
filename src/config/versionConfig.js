...
// 从 localStorage 读取已保存的版本，默认 v1.1.0
const savedVersion = (typeof localStorage !== 'undefined' && localStorage.getItem('soas-version')) || 'v1.1.0'
...
export function useFeatureFlags() {
  const flags = computed(() => {
    return featureMap[versionState.current] || featureMap['v1.1.0']
  })
  return flags
}
